  ...
  <div class="betting-provider">
    ...
    <div class="betting-provider__info">
      ...
      <div class="betting-provider__score">
        ...
        <div class="betting-provider__rating">
          <div class="betting-provider__stars">
            ...
            <div class="betting-provider__stars-cover" :style="starsCoverStyle"></div>
          </div>
          <span>{{ rating }}/5</span>
        </div>
      </div>
